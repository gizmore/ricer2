Rails.application.configure do
  ...
  config.ricer_default_server = 'ircs://irc.gizmore.org:6666'
  ...
  config.action_mailer.smtp_settings = {
    :address => 'ricer2.gizmore.org',
    :port => 587,
    :domain => 'ricer2.gizmore.org',
  ...
  config.middleware.use ExceptionNotifier,
    :email_prefix => "[Ricer2Prod] ",
    :sender_address => %{"RicerBot" <ricer@ricer2.gizmore.org>},
